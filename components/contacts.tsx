...
const ContactPage = () => {
  ...
  return (
    <div className="w-full bg-background text-foreground pt-26 dark:bg-gray-900 dark:text-gray-100" id='contact'>
    {/* Header Section */}
    ...
    <div className="max-w-6xl mx-auto px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea 
                className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 h-32 dark:bg-gray-700 dark:text-gray-100"
        ...
        <div>
          <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl mb-8">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Connect With Us</h2>
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="bg-white dark:bg-gray-800 p-3 rounded-lg shadow-md hover:shadow-lg transition-shadow"
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Book a Consultation</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Schedule a free consultation with our data science experts to discuss your specific needs and how we can help.
            </p>
            <button className="w-full bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 font-semibold py-3 px-6 rounded-lg border-2 border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-gray-600 transition-colors">
              Schedule Meeting
            </button>
          </div>
        </div>
